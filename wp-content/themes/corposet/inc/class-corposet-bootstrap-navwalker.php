 ...
 */
class corposet_nav_walker extends Walker_Nav_Menu {	
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			...
			if ( in_array( 'current-nav-item', $classes ) OR in_array( 'current-menu-ancestor', $classes ) ){
				$class_names .= ' active';
			}
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '>';
			$fb_output .= '<li data-customizer-event="corposet-header-menu-event" id="corposet-header-menu-li" class="nav-item"><a class="nav-link add-menu" href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '">' . esc_html__( 'Add a menu', 'corposet' ) . '</a></li>';
			$fb_output .= '</ul>';
