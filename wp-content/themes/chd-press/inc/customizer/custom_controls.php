<?php
  if (class_exists('WP_Customize_Control')) {
    class chdp_Range_Value_Control extends WP_Customize_Control {
  	public $type = 'chdp-range-value';
  ...
  class chdp_Image_Radio_Control extends WP_Customize_Control {
	  
	  public $type = "chdp-image-radio";
  ...
  class chdp_Toggle_Control extends WP_Customize_Control {
    ...
    class chdp_WP_Customize_Category_Control extends WP_Customize_Control {
        /**
         * Render the control's content.
         */
        public function render_content() {
            $dropdown = wp_dropdown_categories(
                array(
                    ...
                    'echo'              => 0,
                    'show_option_none'  => __( 'All', 'chd-press' ),
                    'option_none_value' => '0',
                    'selected'          => $this->value(),
                )
            );
    ...
    class chdp_Custom_Heading_Control extends WP_Customize_Control {

        public $type    =   'chdp-heading';
    ...
    class chdp_Customize_Gallery_Control extends WP_Customize_Control
    {
        ...
        public $type = 'chdp-image-gallery';
        ...
        public function render_content()
        {
            ...
            <label>
                ...
                <input id="edit-gallery" class="button upload_gallery_button" type="button"
                       value="<?php esc_attr_e('Add/Edit Gallery', 'chd-press') ?>"/>
                <input id="clear-gallery" class="button upload_gallery_button" type="button"
                       value="<?php esc_attr_e('Clear', 'chd-press') ?>"/>
    ...
    class chdp_Custom_Link_Control extends WP_Customize_Control {
	    
	    public $type = "chdp-link";
    ...
    class chdp_Custom_Button_Control extends WP_Customize_Control {
	    
	    public $type = "chdp-button";
    ...
    class chdp_Separator_Control extends WP_Customize_Control {
	    
	    public $type = "chdp-separator";
